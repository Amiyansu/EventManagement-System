               ...
               <div id="back">
                    ...
                    <div className="addevents" style={{ display: 'flex', justifyContent: 'center' }}>
                         ...
                         <div className="addevents_box" >
                              <h1 style={{ display: 'flex', justifyContent: 'center' }}>Add Event Details</h1>
                              ...
                              <div className="fields">
                                   ...
                                   <select style={{marginRight:'275px'}} name="category" value={category} placeholder="Please pick event category" onChange={onCategoryChange}>
                                        <option value="Human">Community Events</option>
                                        <option value="Animal">Cultural Events</option>
                                        <option value="Birds">Sports Events</option>
                                        <option value="Social Services">Social Services</option>
                                        <option value="Nature">Fundraising Events</option>
                              ...
                              >
                                   <label style={{ marginRight: '40px' }}>Event Date:   </label>
                                   <TextField
                              ...
                              <div style={{marginTop:'30px'}} className="fields">
                                   <label> Time: </label>
                                   <input type="time" name="etime" value={etime} placeholder="Event Time" onChange={onEtimeChange}></input>
                              </div>

                              <div className="fields" style={{ display: 'flex', justifyContent: 'center',marginTop:'13px' }}>
                                   <label > Address: </label>
                                   <input name="address" value={address} placeholder="Please enter address" onChange={onAddressChange} ></input>
                              </div>
                              <div className="fields">
                                   <label> City: </label>
                              ...
                              <br />
                              <div className="btn btn-outline-success btn-lg " style={{ width: '200px' }} onClick={updateEvents}> Add Event </div>
                         </div>
