...
const Updatevol = () => {
    ...
    return (
        <>
        <Navbar />
            <div id="backuser" style={{
                background: 'linear-gradient(135deg, rgba(0, 255, 217, 0.5), rgba(0, 87, 204, 0.5))',
                ...
                <div className="addevents" style={{ display: 'flex', justifyContent: 'center' }}>
                    ...
                    <div className="addevents_box" >
                        ...
                        <div className="fields" style={{ display: 'flex', justifyContent: 'center' }}>
                            ...
                            <input name="address" value={address} placeholder={user1.user.address} onChange={onAddressChange}></input>
                        </div>
                        <div className="fields">
                            <label> City: </label>
